...
<html>
	...
	<body>
		<div id="content" style="padding-bottom: 30px;">
			...
			<div style="float: left; width: 50px;" class="button"><a href="admin-pages">Back</a></div> <div style="float: left; width: 60px;" class="button"><a href="?delete=<?php echo $_GET['delete']; ?>&yes">Delete</a></div>
		</div>
		<div id="footer">
