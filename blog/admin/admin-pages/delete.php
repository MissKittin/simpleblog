...
<html>
	...
	<body>
		<div id="content" style="padding-bottom: 30px;">
			...
			<div class="button button_in_row"><a href="?">Back</a></div> <div class="button button_in_row"><a href="?delete=<?php echo $_GET['delete']; ?>&yes&<?php echo adminpanel_csrf_printToken('parameter'); ?>=<?php echo adminpanel_csrf_printToken('value'); ?>">Delete</a></div>
		</div>
		<div id="footer">
